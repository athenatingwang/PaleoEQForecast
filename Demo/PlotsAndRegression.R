...
#####################   Read Results   ########################
###############################################################
load(paste("../ResultsDemo/ModAveProbRes.image",sep=""))
load(paste("../ResultsDemo/ModAveLogProbRes.image",sep=""))
load(paste("../ResultsDemo/ModAveForeRes.image",sep=""))

weights <- read.csv("../ResultsDemo/WAICweights.csv")

## Load the file containing the quantiles of the parameter estimates
load(paste("../ResultsDemo/ParamEst.image",sep=""))
...
# load("../ResultsDemo/ModAveProbRes.image")
...
pois.lambda <- weib.alpha <- matrix(0,nfault,150)
...
### remained the same. 
###########################################################################
weights.retro <- read.csv("../ResultsDemo/RetroWAICweights.csv")
...
weights.org <- read.csv("../ResultsDemo/WAICweights.csv")
...
##########################################################################
load(paste("../ResultsDemo/RetroModAveForeRes.image",sep=""))
...
mseres <- read.csv("../ResultsDemo/MAforeBiasVarMSE.csv")

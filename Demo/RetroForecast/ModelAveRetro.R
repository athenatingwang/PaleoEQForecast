...
toccurN.med <- median( as.vector(t.occ[1:K,N1]) )
  ...
  load(paste("../../ResultsDemo/PoisSimRes2/PoisFault-mcmc",faulti,".image",sep=""))
  ...
  load(paste("../../ResultsDemo/GammaSimRes2/GammaFault-mcmc",faulti,".image",sep=""))
  ...
  load(paste("../../ResultsDemo/WeibSimRes2/WeibFault-mcmc",faulti,".image",sep=""))
  ...
  load(paste("../../ResultsDemo/bptSimRes2/bptFault-mcmc",faulti,".image",sep=""))
  load(paste("../../ResultsDemo/bptSimRes2/HPD-toccBPT",faulti,".image",sep=""))
  library(actuar)
  ...
  load(paste("../../ResultsDemo/lnormSimRes2/lnormFault-mcmc",faulti,".image",sep=""))
...
write.csv(cbind(MAbias, MAvar, MAmse, poisbias, poisvar, poismse,
               ...
               "../../ResultsDemo/MAforeBiasVarMSE.csv")
...
save(ave.foreres,file=paste("../../ResultsDemo/RetroModAveForeRes.image",sep=""))

write.csv(ave.foreres$weights,"../../ResultsDemo/RetroWAICweights.csv")
...
save(params,file=paste("../../ResultsDemo/RetroParamEst.image",sep=""))

# This file sources gammafitNoCensor.R and fits a gamma renewal process 
...
#b <- dir("../../Results/GammaSimRes2/GelmanDiag")
#bsub <- substr(b,16,17)
...
#count <- 1
#for (j in bsub){
# temp <- read.csv(paste("../../Results/GammaSimRes2/GelmanDiag/GelmanDiagGamma",j,".csv",sep=""))
...
## n.thin=1000 are used in the gammafitNoCensor.R file.
...
source('../RetroForecast/gammafitNoCensor.R')
...
{
 tryCatch({
   mod <- gammafit(i,inter.NA, t.occ, N, K,n.iter.mc,n.burnin.mc,n.thin.mc)
   catched = TRUE
   }, error=function(e){})
 print(catched)
}
...
write.csv(t(gelman),file=paste("../../ResultsDemo/GammaSimRes2/GelmanDiag/GelmanDiagGamma",i,".csv",sep=""))
save(hpd.gamma,file=paste("../../ResultsDemo/GammaSimRes2/HPDGamma",i,".image",sep=""))
...
#Time difference of 18.52008 mins

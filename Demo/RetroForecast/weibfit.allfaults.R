# This file sources weibfitNoCensor.R and fits a Weibull renewal process 
...
#b <- dir("../../Results/WeibSimRes2/GelmanDiag")
#bsub <- substr(b,15,16)
...
#count <- 1
#for (j in bsub){
# temp <- read.csv(paste("../../Results/WeibSimRes2/GelmanDiag/GelmanDiagWeib",j,".csv",sep=""))
...
## n.thin=1000 are used in the weibfitNoCensor.R file.
...
source('../RetroForecast/weibfitNoCensor.R')
...
{
 tryCatch({
   mod <- weibfit(i,inter.NA, t.occ, N, K,n.iter.mc,n.burnin.mc,n.thin.mc)
   catched = TRUE
   }, error=function(e){})
 print(catched)
}
...
write.csv(t(gelman),file=paste("../../ResultsDemo/WeibSimRes2/GelmanDiag/GelmanDiagWeib",i,".csv",sep=""))
save(hpd.weib,file=paste("../../ResultsDemo/WeibSimRes2/HPDWeib",i,".image",sep=""))
...
#Time difference of 9.490722 mins

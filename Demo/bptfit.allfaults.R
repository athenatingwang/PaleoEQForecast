...
write.csv(t(gelman),file=paste("../ResultsDemo/bptRes/GelmanDiag/GelmanDiagBPT",i,".csv",sep=""))
save(bpt.res,file=paste("../ResultsDemo/bptRes/HPD-toccBPT",i,".image",sep=""))
...
#Time difference of 27.76294 mins

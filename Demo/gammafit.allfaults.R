...
write.csv(t(gelman),file=paste("../ResultsDemo/GammaRes/GelmanDiag/GelmanDiagGamma",i,".csv",sep=""))
save(hpd.gamma,file=paste("../ResultsDemo/GammaRes/HPDGamma",i,".image",sep=""))
...
#Time difference of 25.97337 mins

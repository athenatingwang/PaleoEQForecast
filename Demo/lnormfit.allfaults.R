...
while(!gelman.1.2){
  ...
  if (temp.gelman<=gelman.max){
    ...
    save(mod.mcmc,file=paste("../ResultsDemo/lnormRes/lnormFault-mcmc",i,".image",sep=""))
    write.csv(t(gelman),file=paste("../ResultsDemo/lnormRes/GelmanDiag/GelmanDiaglnorm",i,".csv",sep=""))
   ...
   save(hpd.lnorm,file=paste("../ResultsDemo/lnormRes/HPDlnorm",i,".image",sep=""))
 }
}
...
#Time difference of 9.116893 mins

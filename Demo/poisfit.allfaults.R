...
#b <- dir("../Results/PoisRes/GelmanDiag")
#bsub <- substr(b,15,16)
...
#count <- 1
#for (j in bsub){
# temp <- read.csv(paste("../Results/PoisRes/GelmanDiag/GelmanDiagPois",j,".csv",sep=""))
...
## n.thin=1000 are used in the poisfit.R file.
...
write.csv(t(gelman),file=paste("../ResultsDemo/PoisRes/GelmanDiag/GelmanDiagPois",i,".csv",sep=""))
save(hpd.pois,file=paste("../ResultsDemo/PoisRes/HPDPois",i,".image",sep=""))
...
#Time difference of 6.191329 mins

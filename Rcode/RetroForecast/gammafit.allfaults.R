...
write.csv(t(gelman),file=paste("../../Results/GammaSimRes2/GelmanDiag/GelmanDiagGamma",i,".csv",sep=""))
save(hpd.gamma,file=paste("../../Results/GammaSimRes2/HPDGamma",i,".image",sep=""))

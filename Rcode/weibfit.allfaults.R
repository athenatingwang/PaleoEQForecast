...
write.csv(t(gelman),file=paste("../Results/WeibRes/GelmanDiag/GelmanDiagWeib",i,".csv",sep=""))
save(hpd.weib,file=paste("../Results/WeibRes/HPDWeib",i,".image",sep=""))
